...
export const NAV_SECTIONS = [
  ...
  { segment: "documents", label: "Documents", built: false },
  { segment: "customs", label: "Customs & Compliance", built: false },
  { segment: "delivery-orders", label: "Delivery Orders", built: false },
  { segment: "mofaic", label: "MOFAIC Follow-up", built: false },
  { segment: "physical-documents", label: "Physical Documents", built: false },
  { segment: "exceptions", label: "Exceptions", built: false },
  { segment: "reports", label: "Reports", built: false },
  { segment: "import", label: "Historical Data Import", built: false },
  { segment: "master-data", label: "Master Data", built: false },
  { segment: "audit", label: "Audit Log", built: false },
  { segment: "discovery", label: "Discovery & Sign-off", built: false },
  { segment: "admin", label: "Administration", built: false },
] as const;
