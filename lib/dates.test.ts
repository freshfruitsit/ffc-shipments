...
import { dubaiTodayISODate, formatDubaiDate, formatDubaiDateTime, formatMoney, daysFromDubaiNow } from "@/lib/dates";
...
describe("formatDubaiDate", () => {
  it("formats an ISO date as DD-MM-YYYY (exact prototype convention)", () => {
    ...
    expect(formatDubaiDate("2026-03-15T12:00:00Z")).toBe("15-03-2026");
  });
  ...
  it("converts a late-UTC timestamp into the correct next Dubai day", () => {
    ...
    expect(formatDubaiDate("2026-03-14T23:00:00Z")).toBe("15-03-2026");
  });
});

describe("formatDubaiDateTime", () => {
  it("formats an ISO timestamp as DD-MM-YYYY HH:mm (exact prototype convention)", () => {
    expect(formatDubaiDateTime("2026-03-15T10:30:00Z")).toBe("15-03-2026 14:30");
  });
...
describe("formatMoney", () => {
  it("formats a value with currency prefix and 2 decimal places", () => {
    expect(formatMoney(9840, "USD")).toBe("USD 9,840.00");
  });
